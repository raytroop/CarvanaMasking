...
def train_and_evaluate(model, train_dataloader, val_dataloader, optimizer, loss_fn, metrics, params, model_dir,
                       restore_file=None, scheduler=None):
    ...
    if restore_file is not None:
        ...
        utils.load_checkpoint(restore_path, model, optimizer if params.optim_restore else None)
...
if __name__ == '__main__':
    ...
    Net = getattr(net, params.model)    # pylint: disable=E1101
    model = Net(params).cuda() if params.cuda else Net(params)
    optimizer = optim.Adam(model.parameters(), lr=params.learning_rate) # pylint: disable=E1101
    ...
    # Train the model
    logging.info("Starting training for {} epoch(s)".format(params.num_epochs)) # pylint: disable=E1101
    train_and_evaluate(model, train_dl, val_dl, optimizer, loss_fn, metrics, params, args.model_dir,
                       args.restore_file, scheduler=None)
